            ...
            if isAllowed then
                ...
                if distance <= locationConfig.ActionDistance then
                    ...
                    if PromptHasHoldModeCompleted(PromptList) then
                        ...
                        local is_data_exists = Citizen.InvokeNative(0x345EC3B7EBDE1CB5, GetEntityCoords(PlayerPedId()), locationConfig.ActionDistance,
                        ...
                        for i = 1, 10, 1 do
                            ...
                            if scenario ~= 0 then
                                if GetHashKey("PROP_PLAYER_BARBER_SEAT") == Citizen.InvokeNative(0xA92450B5AE687AAF, scenario) or -289473187 == Citizen.InvokeNative(0xA92450B5AE687AAF, scenario) then
                                    ...
                                    Citizen.InvokeNative(0x322BFDEA666E2B0E, PlayerPedId(), locationConfig.Coords.x, locationConfig.Coords.y, locationConfig.Coords.z, locationConfig.ActionDistance, -1, true, true, true, true)
                                end
                            end
                        end
...
if Config.Chairs ~= false then
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            for _, location in pairs(Config.Chairs) do
