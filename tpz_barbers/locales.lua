...
Locales = {
    ...
    ['NUI_BEARD_BUTTON']                = "Beard Styles",
    ['NUI_BEARDSTABBLE_BUTTON']         = "Beard Stabble",
    ['NUI_MAIN_PAGE_DESCRIPTION']       = "A barbershop where style meets confidence—expert haircuts and beard grooming tailored to refresh your look and match your personality. Step in for a change, step out with a sharper, more confident you.",
    ...
    ['NUI_GROOM_BEARDSTABBLE_INFO']     = "A precise trim that evens the beard into clean stubble, with light shaping on the neckline and cheeks for a sharp, natural look.",
    ...
    ['COST_DESCRIPTION']                = "The total cost for doing this change will cost you %s dollars.",
    ['CANCEL_BUTTON']                   = "Cancel",
    ['CONFIRM_BUTTON']                  = "Accept & Pay",
}
